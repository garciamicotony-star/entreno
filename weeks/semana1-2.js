        ...
        },
        {
          ...
          exercises: [
            ...
            },
            {
              ...
              muscle: 'Tríceps (aislamiento)',
              altHeader: 'Alternativa si la polea está ocupada',
              alternatives: [
                {
                  appName: 'Cable Tricep Kickback',
                  name: 'Patada de tríceps unilateral en polea',
                  steps: [
                    'Polea baja, torso ligeramente inclinado hacia delante',
                    'Codo pegado al costado a 90°',
                    'Extiende el brazo hacia atrás manteniendo el codo fijo',
                    'Aprieta arriba 1 segundo'
                  ],
                  tip: { bold: 'El codo NO se mueve.', text: 'Si baja o sube, el ejercicio pierde efecto.' }
                }
              ]
            }
          ]
      ...
      groups: [
        ...
        },
        {
          ...
          exercises: [
            ...
            {
              id: 'd2e6', icon: '📏',
              name: 'Curl bayesian en polea unilateral',
              muscle: 'Bíceps cabeza larga (estiramiento)',
              altHeader: 'Alternativa si la polea está ocupada',
              alternatives: [
                {
                  appName: 'Cable One Arm Curl',
                  name: 'Curl unilateral en polea baja',
                  steps: [
                    'Polea baja detrás de ti (un paso por delante de la máquina)',
                    'Brazo estirado hacia atrás, codo a la altura del torso',
                    'Sube doblando solo el codo, sin mover el hombro',
                    'Baja lento al estiramiento máximo'
                  ],
                  tip: { bold: 'Esta posición trabaja la cabeza larga del bíceps en estiramiento —', text: 'fundamental para crecimiento.' }
                }
              ]
            }
          ]
      ...
      groups: [
        ...
        },
        {
          ...
          exercises: [
            ...
            {
              id: 'd3e7', icon: '🪢',
              name: 'Extensión de tríceps por encima de la cabeza cuerda',
              muscle: 'Tríceps cabeza larga',
              altHeader: 'Alternativa si la polea está ocupada',
              alternatives: [
                {
                  ...
                  tip: { bold: 'Codos quietos —', text: 'si se mueven hacia delante, el tríceps deja de trabajar.' }
                }
              ]
            }
          ]
